...
export default function CardRecipe() {
  return (
    <div
      className="bg-white rounded-lg shadow-xl p-6 hover:cursor-pointer hover:shadow-2xl transition-all duration-300"
    >
      <Image className="aspect-video object-cover" src="/assets/recipe.jpg" width={300} height={200} alt="receita" />
